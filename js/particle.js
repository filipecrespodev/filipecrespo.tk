...
//	Description: This javascript file is using as Particle Background Animation.
//	Version: 1.0
...
//  ====================================================================
			...
			var mouse = {x:0, y:0};
			var particles = [];
			var colors = [ "#1655a2","#29b0b4","#873e5c" ];
			...
			function TimeUpdate(e) {
				...
				for( var i = 0; i < len; i++ ) {
					...
					if (!particle.frozen) {
						...
						distanceFactor = Math.max( Math.min( 0 - ( distanceFactor / 10 ), 10 ), 1 );
